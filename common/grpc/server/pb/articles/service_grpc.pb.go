...
type ArticleServiceClient interface {
	...
	UpdateArticleBody(ctx context.Context, in *UpdateArticleBodyRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	UpdateArticleTitle(ctx context.Context, in *UpdateArticleTitleRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	DeleteArticle(ctx context.Context, in *DeleteArticleRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	SetArticleVisibility(ctx context.Context, in *SetArticleVisibilityRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	ToggleArticleLike(ctx context.Context, in *ToggleArticleLikeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *articleServiceClient) UpdateArticleBody(ctx context.Context, in *UpdateArticleBodyRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *articleServiceClient) UpdateArticleTitle(ctx context.Context, in *UpdateArticleTitleRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *articleServiceClient) SetArticleVisibility(ctx context.Context, in *SetArticleVisibilityRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *articleServiceClient) ToggleArticleLike(ctx context.Context, in *ToggleArticleLikeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type ArticleServiceServer interface {
	...
	UpdateArticleBody(context.Context, *UpdateArticleBodyRequest) (*emptypb.Empty, error)
	UpdateArticleTitle(context.Context, *UpdateArticleTitleRequest) (*emptypb.Empty, error)
	DeleteArticle(context.Context, *DeleteArticleRequest) (*emptypb.Empty, error)
	SetArticleVisibility(context.Context, *SetArticleVisibilityRequest) (*emptypb.Empty, error)
	ToggleArticleLike(context.Context, *ToggleArticleLikeRequest) (*emptypb.Empty, error)
...
func (UnimplementedArticleServiceServer) UpdateArticleBody(context.Context, *UpdateArticleBodyRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateArticleBody not implemented")
}
func (UnimplementedArticleServiceServer) UpdateArticleTitle(context.Context, *UpdateArticleTitleRequest) (*emptypb.Empty, error) {
...
func (UnimplementedArticleServiceServer) SetArticleVisibility(context.Context, *SetArticleVisibilityRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetArticleVisibility not implemented")
}
func (UnimplementedArticleServiceServer) ToggleArticleLike(context.Context, *ToggleArticleLikeRequest) (*emptypb.Empty, error) {
