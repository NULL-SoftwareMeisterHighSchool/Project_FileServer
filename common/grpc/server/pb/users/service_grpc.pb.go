...
type UserEventServiceClient interface {
	PublishUserCreated(ctx context.Context, in *CreateUserEvent, opts ...grpc.CallOption) (*emptypb.Empty, error)
	PublishUserDeleted(ctx context.Context, in *DeleteUserEvent, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userEventServiceClient) PublishUserCreated(ctx context.Context, in *CreateUserEvent, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *userEventServiceClient) PublishUserDeleted(ctx context.Context, in *DeleteUserEvent, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type UserEventServiceServer interface {
	PublishUserCreated(context.Context, *CreateUserEvent) (*emptypb.Empty, error)
	PublishUserDeleted(context.Context, *DeleteUserEvent) (*emptypb.Empty, error)
...
func (UnimplementedUserEventServiceServer) PublishUserCreated(context.Context, *CreateUserEvent) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PublishUserCreated not implemented")
}
func (UnimplementedUserEventServiceServer) PublishUserDeleted(context.Context, *DeleteUserEvent) (*emptypb.Empty, error) {
